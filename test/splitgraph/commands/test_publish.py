...
def test_publish(empty_pg_conn, snapper_conn, extra_info):
    ...
    image_hash, published_dt, provenance, readme, schemata, previews = get_published_info(snapper_conn, 'output', 'v1')
    ...
    image_hash, published_dt, provenance, readme, schemata, previews = get_published_info(snapper_conn, 'output', 'v2')
