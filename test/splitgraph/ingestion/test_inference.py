...
def test_inference():
    ...
    assert _infer_column_schema(["1", None, "", "4"]) == "integer"
    assert (
        _infer_column_schema(["2020-01-01 12:34:56", "2020-01-02 00:00:00.123", None])
        == "timestamp"
    )
    assert _infer_column_schema([None, ""]) == "character varying"
