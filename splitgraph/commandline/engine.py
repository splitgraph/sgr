...
@click.option("--cap-add", help="Add kernel capabilities to the engine container", multiple=True, default=[])
@click.argument("name", default=DEFAULT_ENGINE)
@click.password_option()
def add_engine_c(
    image, port, username, no_init, no_sgconfig, inject_source, no_pull, name, password, set_default, cap_add
):
    """
